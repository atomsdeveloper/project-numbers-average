...
let selectNumbers = window.document.querySelector('div#selectNumbers');
...
function add() {
    if (isNumber(addNumber.value) && !isList(addNumber.value, logNumber)) {  // Chamando as funções á cima juntamente com os parâmetros.
        ...
        let item = window.document.createElement('div')  // Criando um elemento 'option' que esá armazenado na minha váriavel 'item'.
